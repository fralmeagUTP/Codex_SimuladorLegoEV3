...
### Requisito: Protocolo IPC versionado del worker
...
#### Escenario: Cancelación no cooperativa
...
### Requisito: Aislamiento de ejecución y política de watchdog
...
#### Escenario: Programa no cooperativo
