# Especificación: paridad de interfaces

## Propósito

Garantizar que las interfaces web y Tkinter ofrezcan el mismo producto funcional
del Simulador EV3 Pybricks.

## Requisitos añadidos

### Requisito: Paridad funcional obligatoria
...
#### Escenario: Nueva función de simulación
...
### Requisito: Contrato compartido de experiencia
...
#### Escenario: Ejecución de un mismo programa
...
#### Escenario: Divergencia de interfaz detectada
