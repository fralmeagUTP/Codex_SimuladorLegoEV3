...
### Requisito: Estado de sesión y entrega final
...
#### Escenario: Finalización con estado de brick
...
### Requisito: Contrato versionado de snapshots
...
#### Escenario: Evento fuera de orden
