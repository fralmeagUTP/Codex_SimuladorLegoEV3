...
La aplicación Tkinter MUST mostrar primero una pantalla de inicio centrada de 800×600 píxeles y MUST abrir después la ventana principal maximizada.

#### Scenario: Inicio normal de la aplicación

- **WHEN** el usuario inicia el punto de entrada de escritorio
- **THEN** se muestra la introducción de 800×600 px
