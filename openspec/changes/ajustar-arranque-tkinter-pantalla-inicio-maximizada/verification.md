...
- `tests/ui/test_ui.py`: 88 aprobadas.
...
La regresión unitaria confirma que una pantalla de 1920×1080 centra la introducción en `800x600+560+240` y que el lanzador solicita el estado Tk `zoomed` para la ventana principal.
