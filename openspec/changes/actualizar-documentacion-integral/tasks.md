...
- [ ] 4.2 Actualizar despliegue Linux/contenedor sin privilegios, backup y recuperacion. Bloqueada parcialmente: `Dockerfile` usa `EV3_APP_ENV`, pero la configuracion lee `EV3_WEB_APP_ENV`; requiere un cambio de producto separado antes de declarar el despliegue por defecto como seguro.
