# Delta de especificación: editor de mundos visual

## Requisito: experiencia guiada de autoría visual

El Editor de Mundos DEBE presentar las acciones de Archivo, Edición y
Simulación en grupos distinguibles. DEBE ofrecer una biblioteca categorizada de
assets con nombre, tooltip y nombre accesible, y DEBE mostrar una guía de
...
### Escenario: crear un primer mundo desde lienzo vacío
...
### Escenario: editar una propiedad del dominio
...
## Requisito: tamaño y capas del mundo

El Editor de Mundos DEBE permitir definir Ancho y Alto en celdas, usar presets
de tamaño y mostrar una equivalencia física. DEBE proporcionar una lista de
...
### Escenario: seleccionar objetos superpuestos
...
### Escenario: cambiar a un preset menor
...
## Requisito: paridad funcional del editor

Las interfaces Web y Tkinter DEBEN ofrecer las mismas operaciones de creación,
...
### Escenario: mundo creado en una interfaz
